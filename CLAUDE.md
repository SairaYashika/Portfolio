...
about.html              About: intro, one "Soyuns" photo gallery (three staggered columns, each one 4:3 + one 3:4 frame, so the block is a clean rectangle), footer with local time
